---
title: "Dendogram Analysis: Streamwater Chemistry"
...
stream_hc_complete <- hclust(stream_dist, method = "complete") # creat logical clusters

plot(stream_hc_complete, cex = 0.6, hang = -1) # plot dendogram
```
